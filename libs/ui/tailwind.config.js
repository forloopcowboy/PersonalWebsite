...
// Consumed by app-level tailwind configs via `presets: [preset]`.
...
export default {
  ...
  safelist: [
    ...
    {
      pattern:
        /((!?)(bg|text|border|fill|stroke|ring)((-severity-(success|warning|danger|important|neutral)(-(light|dark))?)|(-(gray|orange|green|blue))(-(lightest|lighter|light|dark|darker))?(-contrasted)?))/,
      variants: ['hover', 'focus'],
    },
    {
      // For order status buttons.
      pattern:
        /((bg|text)((-secondary-(pink|purple|orange|red|green|teal|blue|navy|gray))|(-(gray|orange|green|blue))(-(lightest|lighter|light|dark|darker))?(-contrasted)?))/,
      variants: ['before', 'active', 'hover'],
    },
    {
      pattern: /((!?)(bg-severity-(success|warning|danger|important|neutral)?(-contrasted)?))/,
      variants: ['before'],
    },
    {
