...
{/* TODO(user): 3–5 bullets. Possibles:
  - the prompt structure and how "opinionated" gets encoded
  - any data sources you pull in (price feeds, news, fundamentals)
  - caching / cost work
  - the deployment story (where it runs, how cheap it is to keep up) */}
